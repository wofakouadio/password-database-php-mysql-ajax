...
function email($recipientEmail,$emailSubject,$msg,$fromEmailAddress,$fromEmailAddressPassword,$fromText,$smtpHost){
...
try {
    ...
    $mail->Host       = $smtpHost; //'mail.kingdomissues.com';                    // Set the SMTP server to send through
    $mail->SMTPAuth   = true;                                   // Enable SMTP authentication
    $mail->Username   = $fromEmailAddress;                     // SMTP username
    $mail->Password   = $fromEmailAddressPassword;                               // SMTP password
    ...
    //Recipients
    $mail->setFrom($fromEmailAddress, $fromText);
    $mail->addAddress($recipientEmail);     // Add a recipient
    //$mail->addAddress('ellen@example.com');               // Name is optional
    $mail->addReplyTo($fromEmailAddress, $fromText);
                            ...
                            <td valign='top' align='center'>
                              <div class='contentEditableContainer contentImageEditable'>
                                <div class='contentEditable'>
                                  <img src='http://kingdomissues.com/wp-content/uploads/2019/06/weblog.png' width='251'  alt='' data-default='placeholder' data-max-width='560'>
                                </div>
                              </div>
                            </td>
                          </tr>
                              ...
                              <div class='contentEditableContainer contentTextEditable'>
                                <div class='contentEditable' align='center'>
                                  <p >
                                    ...
                                    Cheers,
                                    <br>
                                    <span style='color:#222222;'>Administrator</span>
                                  </p>
                                </div>
                              </div>
                            </td>
      ...
      <td valign='top' class='specbundle'><div class='contentEditableContainer contentTextEditable'>
                                      <div class='contentEditable' align='center'>
                                        <p  style='text-align:left;color:#CCCCCC;font-size:12px;font-weight:normal;line-height:20px;'>
                                          <span style='font-weight:bold;'>TECKERNEL</span>
                                          <br>
                                          TEMA - GHANA
                                          <br>
    ...
    <tr>
      <td valign='top' width='52'>
                                    <div class='contentEditableContainer contentFacebookEditable'>
                                      <div class='contentEditable'>
                                        <a target='_blank' href='#'><img src='https://api.app.teckernel.com/images/facebook.png' width='52' height='53' alt='facebook icon' data-default='placeholder' data-max-width='52' data-customIcon='true'></a>
                                      </div>
                                    </div>
                                  </td>
      ...
      <td valign='top' width='52'>
                                    <div class='contentEditableContainer contentTwitterEditable'>
                                      <div class='contentEditable'>
                                        <a target='_blank' href='#'><img src='https://api.app.teckernel.com/images/twitter.png' width='52' height='53' alt='twitter icon' data-default='placeholder' data-max-width='52' data-customIcon='true'></a>
                                      </div>
                                    </div>
                                  </td>
    </tr>
